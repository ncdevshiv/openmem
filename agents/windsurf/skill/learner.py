#!/usr/bin/env python3
"""
OpenMem Memory Skill for Windsurf.
...
def cmd_status(args, context):
    ...
    try:
        ...
        return {
            "response": f"""📊 **OpenMem Status (Windsurf)**
...
def cmd_search(args, context):
    """Search memories."""
    if not args:
        return {"response": "Usage: @memory search <query>", "success": False}
...
COMMANDS = {
    ...
    "evolve": cmd_evolve,
    "help": lambda a, c: {
        "response": f"""📖 **OpenMem Help (Windsurf)**
