# OpenMem — Qwen Code Memory Skill

_Autonomous memory for Qwen Code, powered by OpenMem._
...
2. **Context**: Memory context is injected into `.qwen/memory_context.md`
...
python bin/launcher.py --skill qwen_code
```
...
- `learner.py` — Command handler for Qwen Code
