# OpenMem — OpenCode Memory Skill

_Autonomous memory for OpenCode, powered by OpenMem._
...
2. **Context**: Memory context is injected into `.opencode/context.md`
...
python bin/launcher.py --skill opencode
```
...
- `learner.py` — Command handler for OpenCode
