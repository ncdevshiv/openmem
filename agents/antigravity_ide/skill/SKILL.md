# OpenMem — Antigravity IDE Memory Skill

_Autonomous memory for Antigravity IDE, powered by OpenMem._
...
2. **Context**: Memory context is injected into `.antigravity/memory.md`
...
python bin/launcher.py --skill antigravity_ide
```
...
- `learner.py` — Command handler for Antigravity IDE
