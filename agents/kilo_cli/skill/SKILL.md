# OpenMem — Kilo CLI Memory Skill

_Autonomous memory for Kilo CLI, powered by OpenMem._
...
2. **Context**: Memory context is injected into `.kilo/context.md`
...
python bin/launcher.py --skill kilo_cli
```
...
- `learner.py` — Command handler for Kilo CLI
