# OpenMem — Any Agent Memory Skill

_Autonomous memory for Any Agent, powered by OpenMem._
...
2. **Context**: Memory context is injected into `.openmem/sessions/_memory_context.txt`
...
python bin/launcher.py --skill generic
```
...
- `learner.py` — Command handler for Any Agent
