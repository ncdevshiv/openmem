# OpenMem — Cursor Memory Skill

_Autonomous memory for Cursor, powered by OpenMem._
...
2. **Context**: Memory context is injected into `.cursor/rules/memory.md`
...
- `learner.py` — Command handler for Cursor
