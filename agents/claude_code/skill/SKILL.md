# OpenMem — Claude Code Memory Skill

_Autonomous memory for Claude Code, powered by OpenMem._
...
2. **Context**: Memory context is injected into `CLAUDE.md`
...
python bin/launcher.py --skill claude_code
```
...
- `learner.py` — Command handler for Claude Code
