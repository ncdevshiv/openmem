#!/usr/bin/env python3
"""
OpenMem Memory Skill for OpenClaw.
...
def cmd_status(args, context):
    ...
    try:
        ...
        return {
            "response": f"""📊 **OpenMem Status (OpenClaw)**
...
def cmd_search(args, context):
    """Search memories."""
    if not args:
        return {"response": "Usage: /lm search <query>", "success": False}
...
COMMANDS = {
    ...
    "evolve": cmd_evolve,
    "help": lambda a, c: {
        "response": f"""📖 **OpenMem Help (OpenClaw)**
