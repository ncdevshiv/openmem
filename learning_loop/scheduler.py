...
class LearningScheduler:
    ...
    def run_cycle(self, full: bool = False) -> Dict:
        ...
        print(f"[Scheduler] Cycle completed in {duration:.1f}s")
        return report
